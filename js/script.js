/* ============================================================
   ...
   Contact form, Brochure PDF modal, misc helpers.
   ============================================================ */
(function(){
  "use strict";
  ...
  /* ---------- 13. Brochure PDF preview modal ---------- */
  function initPdfModal(){
    const modal = $('#pdfModal');
    const frame = $('#pdfModalFrame');
    if(!modal || !frame) return;

    const titleEl = $('#pdfModalTitle', modal);
    const downloadEl = $('#pdfModalDownload', modal);
    const viewButtons = $$('.brochure-view-btn');

    const openModal = (pdfUrl, title) => {
      frame.src = pdfUrl;
      titleEl.textContent = title || 'Brochure Preview';
